...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2023 a las 09:52:56
...
--
-- Volcado de datos para la tabla `socias`
--

INSERT INTO `socias` (`id`, `dni_nie`, `nombre`, `apellido`, `fecha_nacimiento`) VALUES
(1, '52057793F', 'raquel', 'tarillo', '2013-01-02'),
(2, '76896643W', 'jacinto', 'madrid', '1990-06-11'),
(3, '45779985F', 'maria', 'alvarado', '2001-06-27'),
(4, '52456654S', 'bruna', 'Alvarado', '2023-01-10'),
(5, '52057793F', 'raquel', 'tarrillo', '2013-01-02');
...
('root', '[{\"db\":\"biblioteca\",\"table\":\"libros\"},{\"db\":\"biblioteca\",\"table\":\"socias\"},{\"db\":\"iblioteca\",\"table\":\"socias\"}]');
...
('root', '2023-01-27 07:52:59', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
